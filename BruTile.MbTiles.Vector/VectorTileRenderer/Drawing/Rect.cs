...
public struct Rect
{
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj is Rect rect && Equals(rect) || obj is System.Drawing.Rectangle rectangle && Equals(rectangle);
    }
    ...
    public bool Contains(Coordinate pt) => Contains(pt.X, pt.Y);
    ...
    public Rect Offset(Coordinate dr) => Offset(dr.X, dr.Y);
