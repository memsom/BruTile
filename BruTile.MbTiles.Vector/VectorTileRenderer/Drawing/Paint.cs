...
public class Paint
{
    ...
    public Coordinate FillTranslate { get; set; } = new();
    public double FillOpacity { get; set; } = 1;

    public SKColor LineColor { get; set; }
    public string LinePattern { get; set; }
    public Coordinate LineTranslate { get; set; } = new();
    ...
    public Coordinate IconOffset { get; set; } = new();
    ...
    public Coordinate TextOffset { get; set; } = new();
