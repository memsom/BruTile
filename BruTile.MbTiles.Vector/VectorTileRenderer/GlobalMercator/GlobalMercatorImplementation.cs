...
public class GlobalMercatorException : Exception
{
    public GlobalMercatorException(string? message) : base(message)
    {
    }

    public GlobalMercatorException(string? message, Exception? innerException) : base(message, innerException)
    {
    }
}
public class GlobalMercatorImplementation
{
    ...
    public CoordinatePair LatLonToMeters(double lat, double lon)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(LatLonToMeters), ex);
        }
    }
    ...
    public CoordinatePair MetersToLatLon(double mx, double my)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(MetersToLatLon), ex);
        }
    }
    ...
    public CoordinatePair PixelsToMeters(double px, double py, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(PixelsToMeters), ex);
        }
    }
    ...
    public CoordinatePair MetersToPixels(double mx, double my, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(MetersToPixels), ex);
        }
    }
    ...
    {            
        ...
        {
            throw new GlobalMercatorException(nameof(PixelsToTile), ex);
        }
    }
    ...
    public TileAddress MetersToTile(double mx, double my, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(MetersToTile), ex);
        }
    }
    ...
    public TileAddress LatLonToTile(double lat, double lon, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(LatLonToTile), ex);
        }
    }
    ...
    public TileAddress LatLonToTileXYZ(double lat, double lon, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(LatLonToTileXYZ), ex);
        }
    }
    ...
    public GeoExtent TileBounds(int tx, int ty, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(TileBounds), ex);
        }
    }
    ...
    public GeoExtent TileLatLonBounds(int tx, int ty, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(TileLatLonBounds), ex);
        }
    }
    ...
    public TileAddress GoogleTile(int tx, int ty, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(GoogleTile), ex);
        }
    }
    ...
    public string QuadTree(int tx, int ty, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(QuadTree), ex);
        }
    }
    ...
    public TileAddress QuadTreeToTile(string quadtree, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(QuadTreeToTile), ex);
        }
    }
    ...
    public string LatLonToQuadTree(double lat, double lon, int zoom)
    {
        ...
        {
            throw new GlobalMercatorException(nameof(LatLonToQuadTree), ex);
        }
    }
